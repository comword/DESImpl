...
const WORD SHA256::K[] = {0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5,
...
void SHA256::store_message_bytes(const std::string &hex_str) {
 ...
 */
WORD SHA256::ROTR(const WORD &n, const WORD &x) {
    return (x >> n) | (x << (32 - n));
}
 ...
 */
WORD SHA256::SHR(const WORD &n, const WORD &x) {
    return x >> n;
}
 ...
 */
WORD SHA256::Ch(const WORD &x, const WORD &y, const WORD &z) {
    return (x & y) ^ (~x & z);
}
 ...
 */
WORD SHA256::Maj(const WORD &x, const WORD &y, const WORD &z) {
    return (x & y) ^ (x & z) ^ (y & z);
}
 ...
 */
WORD SHA256::lsigma0(const WORD &x) {
 ...
 */
WORD SHA256::lsigma1(const WORD &x) {
 ...
 */
WORD SHA256::ssigma0(const WORD &x) {
 ...
 */
WORD SHA256::ssigma1(const WORD &x) {
